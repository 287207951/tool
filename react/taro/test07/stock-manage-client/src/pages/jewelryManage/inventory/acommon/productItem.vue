    ...
    <div class="product">
      ...
      <div style="display:flex;flex:6">
        <div class="uLTwo" style="flex:8">
          <div>
            <span class="grayCol">盘点数量：{{productData.cksAmount}}</span>
          </div>
          <div>
            <span class="grayCol">盘点净重：{{productData.cksSuttle}}g</span>
          </div>
          <div>&nbsp</div>
        </div>
        ...
        <div class="uLThree" style="flex:10">
          ...
          <div>
            <span class="grayCol">净重差异：{{parseFloat(productData.suttle.toFixed(2))}}g</span>
          </div>
          <div>&nbsp</div>
        </div>
      </div>
