    ...
    <el-dialog title="包详情" :visible.sync="baoViewTF" :close-on-click-modal="false" width="1280px">
      <el-row class="tabOne">
        <el-col :span="24">
          ...
          净重
          <span class="txtBlack right30">{{packBarData.packTotalSuttle}}g</span>
          毛重
          <span class="txtBlack right30">{{packBarData.packNetTotalWeight}}g</span>
          毛重差异
          <span class="txtBlack right30">{{packBarData.weightDif}}g</span>
          过重备注
...
export default {
  ...
  watch: {
    ...
    packBarData: function(newVal, oldVal) {
      this.packBarData = newVal;
    }
  },
  computed: {},
  methods: {
