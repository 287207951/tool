<template>
  <div class="conBigDiv" v-loading="loadingState">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>出饰转料</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"></div>
      <el-row>
      ...
      >
        ...
        <el-table-column prop="sourceInvoiceNo" label="拣货单号"></el-table-column>
        ...
        <el-table-column prop="createDate" align="center" label="制单时间">
          <tempalate slot-scope="scope">
            <div>{{$api.dateGetDayTime(scope.row.createDate)}}</div>
          </tempalate>
        </el-table-column>
        <el-table-column prop="createDate" align="center" label="出饰时间">
          <tempalate slot-scope="scope">
            <div>{{$api.dateGetDayTime(scope.row.createDate)}}</div>
          </tempalate>
        </el-table-column>
