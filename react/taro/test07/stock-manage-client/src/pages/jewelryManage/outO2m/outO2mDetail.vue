<template>
  <div class="outOfStock" v-loading="loadingState">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>出饰转料详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr" />
      <div>
        <el-table :data="orderTable" style="width: 100%">
          ...
          <el-table-column prop="weight" label="制单人"></el-table-column>
      ...
      <el-row class="reasonWrap">
        <el-col :span="18" class="txt16 txtBold">出饰转料详情</el-col>
        <el-col :span="6" class="itemRight displayFlex txtRight">
          <span>
            <el-button
              type="primary"
              v-if="orderDetail.invoiceStatuValue !== '已出库' && orderDetail.invoiceStatuValue !== '已拒签' && orderDetail.invoiceStatuValue !== '已签收'"
              size="small"
              @click="confirmOutAllot"
            >确认出库</el-button>
          </span>
          <span v-if="orderDetail.invoiceStatuValue === '已出库'">
    ...
    <el-dialog title="出库单详情" :visible.sync="findTableTF" width="1266px">
      ...
      <el-table :data="findTableData.list" show-summary :summary-method="getSummaries" border>
        ...
        <el-table-column prop="packages" align="center" label="料种类" width="100"></el-table-column>
        <el-table-column prop="species" align="center" label="SKU编号" width="100"></el-table-column>
        <el-table-column prop="weight" width="90" align="center" label="重量"></el-table-column>
        ...
        <el-table-column prop="category" align="center" label="库位" width="90"></el-table-column>
