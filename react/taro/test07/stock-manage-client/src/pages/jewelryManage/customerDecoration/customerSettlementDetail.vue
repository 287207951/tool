<template>
  <div class="outOfStock" style="padding-bottom: 100px" v-loading="loadingState">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>出客户饰(结算)详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr" />
      <div>
...
export default {
  ...
  data() {
    return {
      ...
      shipmentDetailList: [],
      sumCloums: ["packTotalSuttle", "ceditMoney"]
    };
  },
  methods: {
    operationFun(data) {
    ...
    printFun() {
      ...
      this.$axios({
        method: "post",
        url: self.$portMain + "/outStockBills/addClientPrint",
        params: params,
        data: null,
        headers: {
    ...
    redRushClick() {
      this.$confirm("此操作将红冲, 是否继续?", "提示", {
        ...
        this.$axios({
          url: this.$portMain + "/outStockBills/updateDataClient",
          method: "post",
          ...
          if (res.data.code == 200) {
            ...
            this.$router.push("customerSettlementList");
            // this.getData()
    ...
    getData() {
      ...
      this.$axios({
        url: this.$portMain + "/outStockBills/findClientData",
        method: "post",
        params: { bizNo: this.bizNo },
        headers: {
          "Content-Type": "application/x-www-form-urlencoded"
