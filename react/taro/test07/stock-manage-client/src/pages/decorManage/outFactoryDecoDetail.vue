<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>出工厂饰审核列表</el-breadcrumb-item>
              ...
              <div class="pro-right">
                ...
                <el-row>
                  ...
                  <el-col :span="12" class="pro-middle">
                    <span v-if="item.carFlower">车花：{{item.carFlower}}</span>&nbsp;
                  </el-col>
                  <el-col
                    :span="4"
                    class="txtFive"
              ...
              <div class="pro-right">
                ...
                <el-row>
                  ...
                  <el-col
                    :span="3"
                    class="txtFive"
                  >出库克重（g）：{{$api.returnFloatNum(item.totailWeight*item.orderSum)}}</el-col>
  ...
  methods: {
    ...
    upAudit(b) {
      ...
      this.$api.formdataPostFun(
        ...
        err => {
          self.loadingTF = false;
          self.$message.error(err.msg || "请求错误：" + url);
        }
      );
    },
          ...
          if (value) {
            ...
            this.$api.formdataPostFun(
              ...
              err => {
                self.loadingTF = false;
                self.$message.error(
                  err.msg || "请求错误：/order/backTrandfOrdersRemarks"
                );
              }
            );
          } else {
