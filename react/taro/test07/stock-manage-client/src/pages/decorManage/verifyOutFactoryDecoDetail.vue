<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>出工厂饰管理列表</el-breadcrumb-item>
      <el-breadcrumb-item>出工厂饰审核详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="hr"/>
            ...
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  ...
                  <el-col :span="4" class="txtFive">出库克重（g）：{{item.standardGold*item.orderSum}}</el-col>
                </el-row>
                <el-row>
            ...
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  ...
                  <el-col :span="3" class="txtFive">出库克重（g）：{{item.totailWeight*item.orderSum}}</el-col>
  ...
  methods: {
    created_fun() {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectApproveFactoryTrandfDetail",
        params,
        res => {
          if (res.code == 200) {
      ...
      this.$api.formdataPostFun(
        ...
        res => {
          if (res.code === 200) {
            ...
            self.sarkData.orderStatus = "2";
            // setTimeout(function() {
            //   // self.created_fun();
            //   self.$router.push("outFactoryDeco");
            // }, 1000);
            self.created_fun();
          }
        },
      ...
      this.$prompt("请输入退回原因", "提示", {
        ...
        if (value) {
          ...
          this.$api.formdataPostFun(
            ...
            res => {
              self.loadingTF = false;
              self.$message.success("驳回成功，正在刷新！");
              self.sarkData.orderStatus = "4";
              self.created_fun();
              // setTimeout(function() {
              //   // self.created_fun();
              //   self.$router.push("outFactoryDeco");
