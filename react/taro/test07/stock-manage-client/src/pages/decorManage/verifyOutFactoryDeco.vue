      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-date-picker
            ...
            @change="searchFun"
          ></el-date-picker>
          <span class="fontStyle">搜索单号</span>
          <el-input
          ...
          <el-button :style="{marginLeft: '20px'}" size="small" type="danger" @click="resetData">重置</el-button>
        </el-col>
      </el-row>
      <el-table
      ...
      >
        ...
        <el-table-column prop="supplierfName" label="发起部门">
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.sponsor == 'D'">天津或者杭州工厂</span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="orderCreateTime" label="操作日期" width="200px"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    resetData() {
      this.search = this.startTime = this.endTime = this.orderTypeId = this.selectedDay = this.orderStatusId = this.rankById =
        "";
      this.created_fun();
    },
    displayAllData(num, size) {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectApproveFactoryOrderTrandf",
        params,
        res => {
          if (res.code == 200) {
    ...
    editGold(elem) {
      ...
      this.$router.push({
        path: "verifyOutFactoryDecoDetail"
