<template>
  <div class="conBigDiv" ref="repleOrder">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>物流饰品库存</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="hr"/>
    <div class="info" v-loading="webLoadingTF">
      <div class="info-top">
        ...
        <el-dialog title :visible.sync="viewBaoTF" width="1200px" :close-on-click-modal="false">
          <span>
            <div>
                    ...
                    <el-row style="height: 35px;">
                      ...
                      <el-col :span="8" class="pro-bottom">
                        <span v-if="!iitem.suitTF">
                          <span
                            v-if="iitem.productTypeName != '套装' &&iitem.extendAttr && iitem.extendAttr != '{}'"
                          >
