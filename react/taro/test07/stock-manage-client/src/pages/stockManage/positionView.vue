...
export default {
  ...
  methods: {
    created_fun() {
      ...
      this.sarkEditTF = this.$api.setPowerSpotThree(sessionStorage.verify,"sark-edit")
    },
    ...
    palletTab() {
      ...
      this.$api.formdataPostFun(self.$portMain + "/bizPlate/select", {}, res => {
