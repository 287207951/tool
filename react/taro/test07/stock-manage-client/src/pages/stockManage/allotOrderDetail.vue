<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>调拨单查看</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="hr"/>
      ...
      <div class="info-top">
        <div class="infot-table">
          ...
          <div class="tr">
            ...
            <div class="td">
              <span v-if="sarkData.orderType == undefined">-</span>
              <span v-if="sarkData.orderType == 6">调拨入库</span>
              <span v-if="sarkData.orderType == 7">调拨出库</span>
            </div>
            ...
            <div class="td">
              ...
              <span v-if="sarkData.orderStatus == '4'" class="redColor">未通过</span>
              ...
              <el-steps :active="stepsActive" finish-status="success" class="steps-list">
                ...
                >
                  ...
                  <div slot="description">
                    <p v-for="(it,ind) in item.processTypeFroms" :key="ind">{{it.operateName}}</p>
                  </div>
                </el-step>
              </el-steps>
            </el-col>
          ...
          <div class="infom-item">
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  <el-col :span="4" class="pro-middle">产品类别：{{item.productType}}</el-col>
                  ...
                  <el-col :span="4" class="txtFive">净重(g)：{{item.goldWeight}}</el-col>
                </el-row>
                <el-row>
            ...
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  ...
                  <el-col :span="3" class="txtFive">净重(g)：{{item.goldWeight}}</el-col>
  ...
  methods: {
    created_fun() {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectOrderTrandfGoldByOrderNo",
        params,
        res => {
          if (res.code == 200) {
