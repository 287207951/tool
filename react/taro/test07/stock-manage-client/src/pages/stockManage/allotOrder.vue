      ...
      >
        ...
        <el-table-column prop="orderType" label="订单来源">
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.orderType == 6">调拨入库</span>
            <span v-if="scope.row.orderType == 7">调拨出库</span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="orderStatus" label="订单状态">
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.orderStatus == '4'" class="redColor">未通过</span>
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectOrderTrandfGold",
        params,
        res => {
          if (res.code == 200) {
            self.pageNum = num;
