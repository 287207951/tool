<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>调拨出库申请详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="hr"/>
          ...
          <div class="infom-item">
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  <el-col :span="18" class="pro-bottom">克重(g)：{{item.totailWeight}}</el-col>
                  ...
                  <div class="pro-right">
                    ...
                    <el-row>
                      ...
                      <el-col
                        :span="7"
                        class="pro-middle"
                      ><span v-if="ielem.carFlower">车花：{{ielem.carFlower}}</span> &nbsp;
                      </el-col>
                    </el-row>
                    <el-row>
