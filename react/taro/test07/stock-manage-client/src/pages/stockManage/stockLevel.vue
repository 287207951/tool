      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div class="proImg">
              <img
                v-if="scope.row.listUrl[0].length >0"
              ...
              <img
                ...
                class="proImg"
              />
              <div class="imgDel"  v-if="scope.row.statu == 2">商品已删除</div>
            </div>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <el-button
              size='small'
              type="primary"
              @click="editStockLevel(scope.row)"
            >设置产品水位</el-button>
          </template>
        </el-table-column>
      </el-table>
