<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>调拨出库申请列表</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"/>
      <el-row>
        ...
        <el-col :span="5">
          ...
          <input type="file" ref="excelInput"  accept=".xls,.xlsx" @change="excelFun" v-show="false" v-if="inputTF"/>-->
      ...
      >
        ...
        <el-table-column prop="orderCreateTime" label="创建时间"></el-table-column>
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectOpretaOrderTrandf",
        params,
        res => {
          if (res.code == 200) {
            self.pageNum = num;
    ...
    editGold(elem) {
      ...
      this.$router.push({
        path: "allotOrderExchOperaDetail",
