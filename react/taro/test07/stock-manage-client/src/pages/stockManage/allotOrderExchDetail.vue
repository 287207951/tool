          ...
          <div class="tr">
            ...
            <div class="td handle">
              <el-button
                ...
                @click="upAudit(true)"
                :loading="loadingTF"
                v-if="sarkData.orderStatus == '1' && hasVerify"
              >一键审批</el-button>
              <el-button
                type="primary"
                size="mini"
  ...
  methods: {
    created_fun() {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectOrderTrandfDetailByOrderNo",
        params,
        res => {
          if (res.code == 200) {
    ...
    upAudit(b) {
      const url = b
        ? "/order/approveTrandfOrdersByOrderNo"
        : "/order/updataTrandfOrdersByOrderNo";
      ...
      this.$api.formdataPostFun(
        ...
        err => {
          self.loadingTF = false;
          self.$message.error(err.msg || "请求错误：" + b);
        }
      );
    },
