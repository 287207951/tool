<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>补货申请详情1</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="hr" />
    <div class="info">
      <div class="info-top">
        <div class="infot-table">
          ...
          <div class="tr">
            ...
            <div
              class="td"
            >约{{ result.endOrderTotalWeight && result.endOrderTotalWeight.toFixed()}}g</div>
      ...
      <orderTableList :order="order" v-for="order in table" :key="order.factoryNo">
        <header @dblclick="changeShow(order)">
          <ul style="width: 92%;">
            ...
            <li>
              <!-- <span>总重量：</span> -->
              <b>约{{ $api.returnFloatNum(order.factoryWeight).toFixed(2) }}g</b>
            </li>
            <li>
              <!-- <span>期望交货日期：</span> -->
          ...
          <div class="option" style="width: 8%;">
            <p @click.stop="excelOutFun(order)" v-show="showExcel">导出Excel</p>
...
export default {
  data() {
    return {
      ...
      table: [],
      excelJur: `order-replenish-execl` // 权限名称
    };
  },
  computed: {
    showExcel() {
      return this.$api.setPowerSpotThree(sessionStorage.verify, this.excelJur);
    }
  },
  created() {
  ...
  methods: {
    ...
    created_fun() {
      ...
      this.$api.formdataPostFun(
        self.$portMain + "/order/selectReplenishOrderByOrderNo",
        params,
        res => {
    ...
    upAudit() {
      ...
      let params = { orderNo: self.orderNo };
      this.$api.formdataPostFun(
        self.$portMain + "/order/updataReplenishOrdersByOrderNo",
        params,
        res => {
