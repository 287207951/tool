<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>调拨出库审核详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="hr"/>
        ...
        <div class="infot-table">
          ...
          <div class="tr">
            ...
            <div class="td">
              ...
              <span v-if="sarkData.receiverUnit == 'D'">金库出给工厂</span>
            </div>
            ...
            <div class="td">
              ...
              <span v-if="sarkData.orderStatus == '4'" class="redColor">驳回</span>
              <span v-if="sarkData.orderStatus == '7'" class="redColor">审核中</span>
            ...
            <div class="td handle">
              <el-button
                ...
                @click="upAudit"
                :loading="loadingTF"
                v-if="(sarkData.orderStatus == '1' || sarkData.orderStatus == '7') && hasVerify"
              >一键审核</el-button>
              <el-button
                type="warning"
            ...
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  ...
                  <el-col :span="16" class="pro-middle">表面工艺：{{item.pait}}</el-col>
                  <!-- <el-col
                    :span="4"
                    class="txtFive"
                ...
                <el-row>
                  ...
                  <el-col :span="12" class="pro-middle"><span v-if="item.carFlower">车花：{{item.carFlower}}</span> &nbsp;</el-col>
                  <el-col
                    :span="4"
                    class="txtFive"
                  >净重(g)：{{$api.returnFloatNum(item.standardGold * item.orderSum)}}</el-col>
                </el-row>
                <el-row>
                  <el-col :span="4" class="pro-bottom">成色：{{item.productCs}}</el-col>
                  <el-col :span="4" class="pro-bottom">克重(g): {{item.standardGold}}</el-col>
                  <el-col :span="12" class="pro-bottom">
                    <b
          ...
          <div class="infom-item">
            <div class="pro-item">
              ...
              <div class="pro-right">
                ...
                <el-row>
                  <el-col :span="20" class="pro-middle">&nbsp;</el-col>
                  <el-col
                    :span="3"
                    class="txtFive"
                  >净重(g)：{{$api.returnFloatNum(item.totailWeight*item.orderSum)}}</el-col>
                  <el-col :span="1" class="redTxt">
                ...
                <el-row>
                  <el-col :span="20" class="pro-middle">克重：{{item.totailWeight}}</el-col>
                  <el-col :span="4" class="txtFive">数量：{{item.orderSum}}</el-col>
                </el-row>
              </div>
            </div>
  ...
  methods: {
    created_fun() {
      ...
      this.$api.formdataPostFun(
        this.$portMain + "/order/selectApproveOrderTrandfByOrderNo",
        params,
        res => {
          if (res.code == 200) {
            ...
            self.orderData.perFroms.forEach((v, i) => {
    ...
    upAudit() {
      ...
      this.$api.formdataPostFun(
        self.$portMain + "/order/approveTrandfOrdersByOrderNo",
        params,
        res => {
          if (res.code === 200) {
            self.loadingTF = false;
            self.$message.success("提交审批成功！");
            this.sarkData.orderStatus = "2";
            this.created_fun();
            // setTimeout(function() {
            //   // self.created_fun();
            //   self.$router.push("allotOrderExch");
            // }, 1000);
          }
        },
        err => {
          self.loadingTF = false;
          self.$message.error(
            err.msg || "请求错误：/order/approveTrandfOrdersByOrderNo"
          );
        }
      );
    },
