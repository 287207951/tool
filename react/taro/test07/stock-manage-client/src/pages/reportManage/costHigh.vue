<template>
  <div class="conBigDiv" v-loading="loadingState">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>工费高开</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"/>
      <el-row>
        <el-col :span="24">
          ...
          ></el-date-picker>
          <span class="txtRight"><el-button type="primary" size="small" @click="excelOut" :loading="loadingState">导出Excel</el-button></span>
        </el-col>
      </el-row>
      <el-table
        :data="orderAllData"
  ...
  methods: {
    ...
    displayAllData() {
      ...
      let params = { PRS:{
       ...
       this.$axios
        .get(self.$portMain + "/WagesOpen/highOpen", params)
        .then(function(res) {
    ...
    excelOut(){
      ...
      let params = { PRS:{
       ...
       this.$axios
        .get(self.$portMain + "/templateExcelstock/wagesHighOpenListExcel", params)
        .then(function(res) {
          if (res.data.code == 200) {
            self.loadingState = false;
            var baseFile = 'data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,' + res.data.data;
            self.fname ="工费高开汇总表." + self.$publicData.base61File[self.$api.getContentType(baseFile)];
