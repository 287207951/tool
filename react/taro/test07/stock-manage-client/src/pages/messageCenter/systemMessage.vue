    ...
    <div>
      ...
      <div>
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <el-tab-pane label="未读消息" name="second" class="tab">
          ...
          <el-tab-pane label="已读消息" name="third" class="tab">
...
export default {
  ...
  methods: {
    ...
    refresh() {
      let self = this;
      Promise.all([self.countFun(), self.systemUnreadCount()])
        .then(result => {
...
.messageWrap .footer .el-checkbox__input {
  padding-top: 0px;
}
</style>
