  ...
  <div class="conBigDiv">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="depart_name" label="发起部门"></el-table-column>
        ...
        <el-table-column label="入料毛重" prop="input_pur_weight"></el-table-column>
        <el-table-column prop="input_net_weight" label="入料折重"></el-table-column>
        <el-table-column prop="output_pur_weight" label="出料毛重"></el-table-column>
        <el-table-column label="出料折重" prop="output_net_weight"></el-table-column>
        <el-table-column label="毛重金额" prop="pur_remainder"></el-table-column>
        <el-table-column label="折重金额" prop="net_remainder"></el-table-column>
      </el-table>
      <div class="pageD">
        <el-pagination
...
export default {
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$axios
        .get(this.$portMain + "/stock/NStockIntoutputListDepart", params)
        .then(function(res) {
