  ...
  <div class="conBigDiv">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="deposit_pur_weight" label="上存毛重"></el-table-column>
        <el-table-column prop="deposit_net_weight" label="上存折重"></el-table-column>
        <el-table-column prop="input_pur_weight" label="入库毛重"></el-table-column>
        <el-table-column prop="input_net_weight" label="入库折重"></el-table-column>
        <el-table-column label="出库毛重" prop="output_pur_weight"></el-table-column>
        <el-table-column prop="output_net_weight" label="出库折重"></el-table-column>
        <el-table-column prop="now_save_pur_weight" label="现存毛重"></el-table-column>
        <el-table-column label="现存折重" prop="now_save_net_weight"></el-table-column>
      </el-table>
      <div class="pageD">
        <el-pagination
...
export default {
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$axios
        .get(this.$portMain + "/stock/stockNowStoreListDepart", params)
        .then(function(res) {
