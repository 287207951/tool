<template>
  <div class="conBigDiv" v-loading="loading">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>报表(系统管理员)</el-breadcrumb-item>
    ...
    <div>
      ...
      <el-row>
        <el-col :span="24">
          ...
          <span class="fontStyle">所属单位</span>
      ...
      >
        ...
        <el-table-column label="入料净重重(g)" prop="input_pur_weight"></el-table-column>
        ...
        <el-table-column label="净重金额(￥)" prop="pur_remainder"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/NStockIntoutputList", params)
        .then(function(res) {
    ...
    resetQueryFun() {
      this.search = this.startTime = this.endTime = this.ustomer_type = this.stockTypeId = this.stockKindId = this.province = this.area = this.selectedDay =
        "";
      this.queryFun();
    },
    // 选择时间
