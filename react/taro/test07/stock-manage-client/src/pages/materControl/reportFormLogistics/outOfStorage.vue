<template>
  <div class="conBigDiv" v-loading="loading">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>报表(物流中心)</el-breadcrumb-item>
...
export default {
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/NStockIntoutputListLogistics", params)
        .then(function(res) {
    ...
    resetQueryFun() {
      this.search = this.startTime = this.endTime = this.customer_type = this.stockTypeId = this.stockKindId = this.province = this.area = this.selectedDay =
        "";
      this.queryFun();
    },
    // 选择时间
