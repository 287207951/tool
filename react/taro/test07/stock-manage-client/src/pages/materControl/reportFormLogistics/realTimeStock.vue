...
export default {
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/stockNowStoreListLogistics", params)
        .then(function(res) {
    ...
    resetQueryFun() {
      this.search = this.startTime = this.endTime = this.stock_kind_id = this.stock_type_id = this.counter_id = this.selectedDay =
        "";
      this.queryFun();
    },
    // 选择时间
