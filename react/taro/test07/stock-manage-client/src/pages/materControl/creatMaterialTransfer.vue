<template>
  <div class="conBigDiv" ref="creatMaterialTransfer">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      <el-breadcrumb-item>尚金缘内部业务管理系统</el-breadcrumb-item>
      <el-breadcrumb-item>原料管理</el-breadcrumb-item>
      <el-breadcrumb-item>新建转饰</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"/>
      <el-row>
      ...
      <el-row class="itemFirst">
        <el-col :span="8">
          <div>
            <span style="display: inline-block;width:56px">出库柜</span>
            <el-select
...
export default {
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.creatMaterialTransfer;
  ...
  methods: {
    ...
    addFun() {
      ...
      // let tableDom = document.querySelector('#tableOne');
      //
      //
      // this.tableHeight = tableDom.offsetHeight + 57;
    },
    // 料明细删除一行
    delItem(index) {
      let self = this;
