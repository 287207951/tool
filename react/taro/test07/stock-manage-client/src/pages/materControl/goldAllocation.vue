  ...
  <div class="conBigDiv" ref="goldAllocation" v-loading="loading">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="红冲1">
          <template slot-scope="scope">
            <span
              v-if="scope.row.HC != 1 && (scope.row.output_statue == 2 || scope.row.output_statue == 4) && scope.row.HCType!= 'HC'"
            >红冲</span>
            <span v-else>--</span>
          </template>
        </el-table-column>
...
export default {
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.goldAllocation;
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/allotOrderList", params)
        .then(function(res) {
          if (res.data.code == 200) {
            ...
            self.allData.forEach(item => {
              ...
              item.HCType = item.allot_code.substr(0, 2);
            });
          } else {
