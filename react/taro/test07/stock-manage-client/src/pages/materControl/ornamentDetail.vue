<template>
  <div class="conBigDiv">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>转料详情</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"/>
      <el-row>
      ...
      <el-row class="itemFirst">
        <el-col :span="8">
          ...
          <div style="margin-top:12px">
            <span style="display: inline-block;width:70px">出库柜：</span>
...
<style>
.conBigDiv #tableTwo .el-table__footer-wrapper {
  display: none;
}

.conBigDiv #tableOne .el-table__footer-wrapper {
  display: none;
}
</style>
