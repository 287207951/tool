<template>
  <div class="conBigDiv" ref="vaultGoldAllocation">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      <el-breadcrumb-item>尚金缘内部业务管理系统</el-breadcrumb-item>
      <el-breadcrumb-item>原料管理</el-breadcrumb-item>
      <el-breadcrumb-item>调拨2</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"/>
      <el-row>
      ...
      >
        ...
        <el-table-column prop="total_weight" label="重量"></el-table-column>
...
export default {
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.vaultGoldAllocation;
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$axios
        .get(this.$portMain + "/stock/depart/allotOrderList", params)
        .then(function(res) {
    ...
    editGold(elem) {
      this.$router.push({
        path: "vaultGoldAllocationDetail",
    ...
    // 新建发料
    createdFun() {
      this.$router.push("vaultCreatGoldAllocation");
    },
    // 查询金料种类
    findStockSetKind() {
      let self = this;
