<template>
  <div class="conBigDiv customTable" ref="vaultGoldAllocationDetail">
    ...
    <div>
      ...
      <el-row>
        ...
        <el-col :span="24" class="itemRight" v-if="allData.output_statue == 2">
      ...
      >
        ...
        <el-table-column header-align="center" align="center" prop="k_weight" label="重量"></el-table-column>
...
export default {
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.vaultGoldAllocationDetail;
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/depart/allotOrderFrom", params)
        .then(function(res) {
    ...
    ConfirmRedflush() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/depart/HCAllotOrder", params)
        .then(function(res) {
          if (res.data.code == 200) {
    ...
    printFun() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/depart/printAllotOrder", params)
        .then(function(res) {
          if (res.data.code == 200) {
            self.$message.success(res.data.msg);
            self.created_fun();
    ...
    toVoid() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/depart/cancellationAllotOrder", params)
        .then(function(res) {
          if (res.data.code == 200) {
            self.$message.success(res.data.msg);
