<template>
  <div class="conBigDiv" ref="vaultSendMaterial">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      <el-breadcrumb-item>尚金缘内部业务管理系统</el-breadcrumb-item>
      <el-breadcrumb-item>原料管理</el-breadcrumb-item>
      <el-breadcrumb-item>发料2</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"/>
      <el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-button type="primary" size="small" @click="createdFun">新建发料</el-button>
      ...
      >
        <el-table-column prop="output_code" label="发料单号"></el-table-column>
        <el-table-column prop="company_name" label="发料部门"></el-table-column>
        ...
        <el-table-column prop="output_fur_total_weight" label="出库毛重"></el-table-column>
...
export default {
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.vaultSendMaterial;
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$axios
        .get(this.$portMain + "/stock/depart/NoutputStockList", params)
        .then(function(res) {
    ...
    // 新建发料
    createdFun() {
      this.$router.push("vaultCreatSendMaterial");
    },
    // 查询金料种类
    findStockSetKind() {
      let self = this;
