    ...
    <div>
      ...
      <el-row>
        <el-col
          :span="24"
          class="itemRight"
          v-if="allData.output_statue == 1 && powerBtnShow == 'true'"
        >
        ...
        <el-col
          :span="24"
          class="itemRight"
          v-if="allData.output_statue == 2 && powerBtnShow == 'true'"
        >
          <el-button
            type="danger"
            size="small"
      ...
      <el-row class="itemFirst">
        ...
        <el-col :span="8">
          ...
          <div style="margin-top:12px" v-if="allData.note != undefined && allData.note != ''">
            <span>备注：</span>
...
export default {
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/allotOrderFrom", params)
        .then(function(res) {
    ...
    ConfirmRedflush() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/HCAllotOrder", params)
        .then(function(res) {
          if (res.data.code == 200) {
    ...
    printFun() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/printAllotOrder", params)
        .then(function(res) {
          if (res.data.code == 200) {
            self.$message.success(res.data.msg);
            // self.$refs.myComp.compPrintFun();
    ...
    toVoid() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/cancellationAllotOrder", params)
        .then(function(res) {
          if (res.data.code == 200) {
            self.$message.success(res.data.msg);
            self.$router.push("logisticGoldAllocation");
