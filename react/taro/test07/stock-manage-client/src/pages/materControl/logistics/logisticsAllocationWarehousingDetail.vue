    ...
    <div>
      ...
      <el-row>
        ...
        <el-col :span="24" class="itemRight">
          ...
          <span v-if="allData.output_statue == 1 && powerBtnShow == 'true'">
            <el-button type="danger" size="small" plain @click="rejectFun">驳回</el-button>
            <el-button type="primary" size="small" @click="passFun">审核通过</el-button>
          </span>
          <span
            v-if="allData.output_statue == 2 && allData.bills_statue == 2 && powerBtnShow == 'true'"
          >
            <el-button
              type="primary"
              size="small"
      ...
      <el-row class="itemFirst">
        ...
        <el-col :span="8">
          ...
          <div style="margin-top:12px">
            <span>入库柜：</span>
            <!-- <span v-if="allData.output_statue != 1">{{allData.position_name}}</span> -->
            <span v-if="allData.output_statue != 1">
              <span v-if="allData.position_name != undefined">{{allData.position_name}}</span>
              <span v-else>----</span>
            </span>
            <el-select
              v-model="positionId"
        ...
        .then(function(res) {
          if (res.data.code == 200) {
            ...
            setTimeout(function() {
              ...
              self.$router.push("logisticsAllocationWarehousing");
            }, 2000);
          } else {
            self.$message.error(res.data.msg);
          }
