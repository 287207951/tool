<template>
  <div class="conBigDiv" ref="logisticSendMaterialDetail">
...
export default {
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.logisticSendMaterialDetail;
  ...
  methods: {
    ...
    displayAllData(num, size) {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/NoutputStockFrom", params)
        .then(function(res) {
    ...
    ConfirmRedflush() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/HCOutputStock", params)
        .then(function(res) {
          if (res.data.code == 200) {
    ...
    printFun() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/logistics/NprintOutputStock", params)
        .then(function(res) {
          if (res.data.code == 200) {
            self.$message.success(res.data.msg);
            // self.$refs.myComp.compPrintFun();
