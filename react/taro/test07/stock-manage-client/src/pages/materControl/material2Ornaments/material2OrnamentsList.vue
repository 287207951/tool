<template>
  <div class="conBigDiv"
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right"
      ...
      <el-breadcrumb-item>料转饰(发起)</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr"></div>
      <el-row>
        <el-col :span="24">
          <el-input placeholder="请输入单号搜索"
          ...
          <el-select v-model="searchForm.depositStatus"
                     placeholder="请选择"
                     size="small"
                     style="width:200px"
                     @change="screenFun">
            <el-option v-for="item in depositStatusOptions"
                       :key="item.companyId"
          ...
          <el-date-picker v-model="selectedDay"
                          ...
                          style="width:300px"
                          @change="searTimechFun"></el-date-picker>
        </el-col>
      </el-row>
      <div style="margin-top:16px;">
        <el-button type="primary"
                   size="small"
                   @click="new2O">新建转饰</el-button>
      </div>
      <el-table :data="tableData"
        ...
        <el-table-column prop="sourceInvoiceNo"
                         label="入库柜">
        </el-table-column>
        <el-table-column prop="recipient"
                         label="料种类">
        ...
        <el-table-column prop="invoiceStatuValue"
                         align="center"
                         label="出库状态">
...
export default {
  ...
  methods: {
    new2O () {
      this.$router.push({ path: "material2OrnamentsDetail" })
    },
    // 获取出库状态options
    ...
    searTimechFun () {
      if (this.selectedDay != null) {
        this.searchForm.startTime = this.$api.dateGetDayTime(this.selectedDay[0]);
