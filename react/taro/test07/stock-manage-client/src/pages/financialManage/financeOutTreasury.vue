  ...
  <div class="conBigDiv" v-loading="loading" ref="toExamine">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="output_code" label="出库单号" width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/NoutputStockListC", params)
        .then(function(res) {
    ...
    checkboxInit(row, index) {
      let showHC = row.output_code.slice(0, 2);
      if (
    ...
    passFun() {
      ...
      let params = {
        outputStockIds: JSON.stringify(adjustIds)
      };
