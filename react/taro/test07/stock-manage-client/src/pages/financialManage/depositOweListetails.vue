    ...
    <div>
      ...
      <el-row style="margin-top:20px; margin-bottom:20px">
        <el-col :span="24">
          ...
          <el-button type="danger" size="small" plain @click="backFun">返回</el-button>
        </el-col>
      </el-row>
      ...
      >
        ...
        <el-table-column label="单号" prop="order_code"></el-table-column>
...
export default {
  ...
  methods: {
    created_fun() {
      // this.$api.dateGetDay()
      this.search = this.$route.query.customerName;
    ...
    //返回
    backFun() {
      this.$router.push("depositOweList");
    },
    //重置
    resetFun() {
      this.resoureCode = ""; //单号
