<template>
  <div class="conBigDiv" ref="goldPriceView" v-loading="loading">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      <el-breadcrumb-item>尚金缘内部业务管理系统</el-breadcrumb-item>
      <el-breadcrumb-item>财务管理</el-breadcrumb-item>
      <el-breadcrumb-item>金价发布</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr" />
      <el-row>
      ...
      >
        ...
        <el-table-column prop="gold_type_value" label="金价"></el-table-column>
    ...
    >
      <div class="newFrame">
        ...
        <div class="itemOneWrap">
          ...
          <div class="itemOne" v-for="(itemClass,itemIndex) in goldPriceProps" :key="itemIndex">
            ...
            <span class="itemOneTitle" style="margin-left:88px">最新金价</span>
            <el-input
              v-model="itemClass.propValue"
              placeholder="请填写对应黄金的金价"
              size="small"
              style="width:200px"
              @blur="checkNumber(itemClass)"
            ></el-input>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveCreate" size="small" :loading="btnSaveLoading">保 存</el-button>
      </span>
    </el-dialog>
    <!-- 金价详情 -->
    <el-dialog
      ...
      <div class="newFrame">
        ...
        <div class="itemOneWrap">
          ...
          <div class="detailWrap">
            ...
            >
              种类：
              <span>{{item.propType}}/{{item.propValue}}</span>
            </div>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      classData: ["足金999", "足金9999", "足金99999"],
      checkType: true, //模拟
      moni: "", //模拟
      laborCostData: [],
  ...
  created() {
    ...
    document.onkeydown = e => {
      ...
      let dom = this.$refs.goldPriceView;
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$axios
        .get(this.$portMain + "/stock/goldPriceList", params)
        .then(function(res) {
    ...
    saveCreate() {
      ...
      this.$api.formdataPostFun(
        self.$portMain + "/stock/createGoldprice",
        params,
        res => {
    ...
    getDetails(item) {
      ...
      this.$axios
        .get(this.$portMain + "/stock/goldPriceForm", params)
        .then(function(res) {
          if (res.data.code == 200) {
    ...
    //校验数字
    checkNumber(itemClass) {
      if (itemClass.propValue != undefined) {
        itemClass.propValue = itemClass.propValue.trim();
      }

      let result = isNaN(itemClass.propValue);
      let result2 = Number(itemClass.propValue) < 0;
      if (result || result2) {
        this.$message.error("请输入正确的金价！");
        itemClass.propValue = "";
      }

      itemClass.propValue = Number(itemClass.propValue).toFixed(2);
    },
    //权限判断
    powerFun() {
      let self = this;
