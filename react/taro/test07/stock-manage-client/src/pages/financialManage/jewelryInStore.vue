<template>
  <div class="conBigDiv" v-loading="loading" ref="toExamine">
    <el-breadcrumb separator-class="el-icon-arrow-right" class="topnav">
      ...
      <el-breadcrumb-item>饰入库</el-breadcrumb-item>
    </el-breadcrumb>
    <div>
      <div class="hr" />
      <el-row>
      ...
      >
        ...
        <el-table-column prop="bizNo" label="入库单号" width="150"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    displayAllData() {
      ...
      this.$api
        .urlPost(this.$portMain + "/financialAudit/listIn", params)
        .then(function(res) {
    ...
    passFun() {
      ...
      this.$api.formdataPostFun(
        self.$portMain + "/financialAudit/approveInData",
        params,
        res => {
